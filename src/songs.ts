...
export const SONG_LIBRARY: SongInfo[] = [
  ...
  // --- 10 More Songs: Diverse Genres & Pacing ---
  {
    id: 'vapor-sunset',
    name: 'Vapor Sunset',
    artist: 'AesthWave',
    ...
    difficulty: 'easy',
    color: '#ff99cc',
    description: 'Dreamy vaporwave vibes as the sun dips below the grid',
  },
  {
    id: 'binary-storm',
    name: 'Binary Storm',
    ...
    difficulty: 'expert',
    color: '#33ff33',
    description: 'A relentless torrent of ones and zeros at 172 BPM',
  },
  {
    id: 'crystal-cave',
    name: 'Crystal Cave',
    ...
    difficulty: 'easy',
    color: '#66ccff',
    description: 'Sparkling melodies echoing through digital caverns',
  },
  {
    id: 'steel-rain',
    name: 'Steel Rain',
    ...
    difficulty: 'hard',
    color: '#999999',
    description: 'Heavy industrial beats pelting down like metal rain',
  },
  {
    id: 'moonwalk',
    name: 'Moonwalk',
    ...
    difficulty: 'medium',
    color: '#ccddff',
    description: 'Low gravity grooves on the lunar surface',
  },
  {
    id: 'plasma-core',
    name: 'Plasma Core',
    ...
    difficulty: 'hard',
    color: '#ff66ff',
    description: 'Superheated rhythms from the reactor core',
  },
  {
    id: 'neon-highway',
    name: 'Neon Highway',
    ...
    difficulty: 'medium',
    color: '#ff6633',
    description: 'Cruising at light speed down an endless neon road',
  },
  {
    id: 'quantum-echo',
    name: 'Quantum Echo',
    ...
    difficulty: 'medium',
    color: '#9966ff',
    description: 'Every beat exists in superposition until you play it',
  },
  {
    id: 'frozen-circuit',
    name: 'Frozen Circuit',
    ...
    difficulty: 'easy',
    color: '#aaeeff',
    description: 'Sub-zero ambient tones frozen in silicon ice',
  },
  {
    id: 'omega-protocol',
    name: 'Omega Protocol',
    ...
    difficulty: 'expert',
    color: '#ff0000',
    description: 'The final test. 210 BPM. No mercy.',
  },
];
